...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse h5" id="navbarResponsive">
          <ul class="navbar-nav ml-auto align-center">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="<?=base_url()?>gallery.php">Gallery</a>
            </li>
            <li class="nav-item">
    ...
    <section>
    	<div class="jumbotron jumbotron-fluid mt-5 bg-primary">
		  <div class="container text-white">
		    ...
		    <p class="lead">Dokumentasi kegiatan selama acara berlangsung</p>
		  </div>
		</div>
    </section>
    ...
    <div class="container">
    	<div class="clearfix">
		  <button type="button" class="btn btn-outline-primary float-right mb-3 mr-2" data-toggle="tooltip" data-placement="left" title="Download">
		  	<i class="material-icons">cloud_download</i></button>
		</div>
    	
      <div class="row text-center text-lg-left">
        <div class="col-lg-3 col-md-4 col-xs-6">
          <a href="#" class="d-block mb-4 h-100 hvr-float" data-toggle="modal" data-target="#exampleModalCenter">
            <img class="img-fluid img-thumbnail" src="<?=base_url()?>assets/home/images/office.jpg" alt="">
          </a>
        </div>
        <div class="col-lg-3 col-md-4 col-xs-6">
          <a href="#" class="d-block mb-4 h-100 hvr-float" data-toggle="modal" data-target="#exampleModalCenter">
	...
	<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
	  <div class="modal-dialog modal-dialog-centered" role="document">
	  	<img src="<?=base_url()?>assets/home/images/office.jpg" class="img-fluid">
	  </div>
	</div>
