    ...
    <header>
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url('<?=base_url()?>assets/home/images/jumb1.jpg')">
          ...
          <div class="carousel-item" style="background-image: url('<?=base_url()?>assets/home/images/jumb2.jpg')">
            <div class="carousel-caption d-none d-md-block">
              <h3>Second Slide</h3>
          ...
          <div class="carousel-item" style="background-image: url('<?=base_url()?>assets/home/images/jumb3.jpg')">
            <div class="carousel-caption d-none d-md-block">
              <h3>Third Slide</h3>
                        ...
                        <div class="col-md-6">            
                          ...
                          <div class="form-row"></div>
                            ...
                            <div class="form-group" hidden>
                              ...
                              <input type="text" name="metode_daftar" class="form-control" id="metodeDaftar" placeholder="Metode Daftar" required value="1">
                            </div>
                        </div>      
                      </div>
                      <div class="">
