  ...
  columns: [
              ...
              {mRender: function (data, type, row) {
                  if (row[19]==0) {
                    ...
                    return '<a class="btn btn-danger far fa-trash-alt"  href="<?= base_url() ?>admin/ajax_delete_peserta_marathon/'+row[12]+'" onclick="return confirm(`Apakah anda yakin untuk menghapus data ini?`)"  title="Hapus Peserta"></a> <a class="btn btn-success far fa-check-circle"  href="<?= base_url() ?>admin/ajax_konfirmasi/'+row[12]+'" onclick="return confirm(`Konfirmasi?`)"  title="Konfirmasi"></a>'

                  }else{
                          return '<a class="btn text-white btn-warning far fa-times-circle"  href="<?= base_url() ?>admin/ajax_batal_konfirmasi/'+row[12]+'" onclick="return confirm(`Apakah anda yakin untuk membatalkan data ini?`)"  title="Batal Konfirmasi"></a>'
                        }
