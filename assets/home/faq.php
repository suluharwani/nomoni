...
<html lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="css/nomoni.min.css">
  <head>
    <meta charset="utf-8">
  ...
  <body>
        ...
        <div class="collapse navbar-collapse h5" id="navbarResponsive">
          <ul class="navbar-nav ml-auto align-center">
            <li class="nav-item active">
              <a class="nav-link" href="http://localhost:8080/palu_nomoni/">Home
                <span class="sr-only">(current)</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="http://localhost:8080/palu_nomoni/#schedule">Schedule</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="http://localhost:8080/palu_nomoni/#route">Route</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="http://localhost:8080/palu_nomoni/gallery.php">Gallery</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" href="http://localhost:8080/palu_nomoni/faq.php">FAQ</a>
            </li>
            ...
            <li class="nav-item">
              <a class="btn btn-primary" href="http://localhost:8080/palu_nomoni/#register">Daftar</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <script src="js/nomoni.js"></script>
